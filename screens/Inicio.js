...
// esLocale no anda, se puede borrar jaja
const esLocale = {
...
// Cuando tocas un dia en el calendario aparece una tarjeta con la info, cuando tocas te manda a la screen por ej TorneoBarPingPong20
// Yo lo que hice fue crear una screen para cada torneo, en un primer momento funciona (tarda pero anda)
// Mas adelante seguro se puede hacer algo para que sea más automatizado pero no tengo problema en hacer el trabajo todo manual los primeros meses
  ...
  const getMessageForDate = (date) => {
                ...
                <TouchableOpacity onPress = { () => { navigation.navigate('TorneoMacabi74') }}>
                 <Torneo>
                   <Cover>
                     ...
                     <Club>Macabi</Club>
                     <Categoria>3ra, 2da, 1ra</Categoria>
   ...
   //Lo de abajo eran torneos viejos, no los borre porque como cargo las cosas manual me es mas rapido copiar y pegar (hasta linea 360)
...
// cuando no hay torneo sale esto
...
// esto es para que se vean con color los dias con torneos (en este caso era 14 de agosto)

  const markedDates = {
    '2023-08-14': { marked: true, dotColor: '', selected: true, selectedColor: '#308446' },
    '2023-08-16': { marked: true, dotColor: '', selected: true, selectedColor: '#308446'  },
    '2023-08-18': { marked: true, dotColor: '', selected: true, selectedColor: '#308446'  },
    '2023-08-19': { marked: true, dotColor: '', selected: true, selectedColor: '#308446'  },
  };
...
// Este es el inicio con un mensaje de bienvenida y debajo el calendario

// message devuelve las tarjetas de arribas con la info cada dia que tocas
