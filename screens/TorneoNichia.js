...
export default function TorneoNichia({ navigation }) {
    return (
      <Container>
...
>
  ...
  />
          ...
          <Lugar source={require("../assets/mesasNichia.jpg")}/>
          ...
          <Organizador>
            ...
            <Informacion>Federico Rosenfeld</Informacion>
          </Organizador>
