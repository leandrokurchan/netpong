...
handleWhatsAppButton = (whatsappNumber) => {
  ...
  const whatsappUrl = `whatsapp://send?phone=+541137283905${whatsappNumber}&text=${encodeURIComponent(message)}`
...
export default function TorneoPadilla691({ navigation }) {
    return (
      <Container>
...
>
  ...
  />
          ...
          <Lugar source={require("../assets/mesasPadilla.jpg")}/>
          ...
          <Categorias>
            ...
            <Informacion>
               <Text>4ta 13hs</Text>
               <Text>{"\n"}</Text>
               <Text>7ma 13:30hs</Text>
               <Text>{"\n"}</Text>
               <Text>2da 16hs</Text>
               <Text>{"\n"}</Text>
               <Text>5ta 16:30hs</Text>
            </Informacion>
          </Categorias>
          <Cupos>
          ...
          <Mesas>
            ...
            <Informacion>3 mesas Almar</Informacion>
          </Mesas>
          <Adaptaciones>
          ...
          <Organizador>
            ...
            <Informacion>Walter Da Fonseca</Informacion>
          </Organizador>
          ...
          <TouchableOpacity onPress={() => {
            ...
            const url = `https://wa.me/+541137283905?text=${encodeURIComponent(message)}`;
...
<View style={{ backgroundColor: '#00B116', marginTop: 295, borderRadius: 10, width: 250, height: 80, alignSelf: 'center' }}>
  ...
  <Button 
    ...
    color="white"
    onPress={() => {
      const url = "https://wa.me/+541137283905";
      Linking.canOpenURL(url).then(supported => {
        if (!supported) {
          console.log("Can't handle url: " + url);
        } else {
