...
export default function TorneoLaQuinta({ navigation }) {
    return (
      <Container>
...
>
  ...
  />
          ...
          <Lugar source={require("../assets/mesasLaQuinta.jpg")}/>
          ...
          <Organizador>
            ...
            <Informacion>Demian Curcio</Informacion>
          </Organizador>
          ...
          <TouchableOpacity onPress={() => {
            ...
            const url = `https://wa.me/1168633277?text=${encodeURIComponent(message)}`;
